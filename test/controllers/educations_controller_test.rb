...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { diploma: @education.diploma, end_date: @education.end_date, location: @education.location, name: @education.name, school: @education.school, start_date: @education.start_date } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { diploma: @education.diploma, end_date: @education.end_date, location: @education.location, name: @education.name, school: @education.school, start_date: @education.start_date } }
